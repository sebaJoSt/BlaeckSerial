...
void UpdateRandomSmallNumber()
{
  // Random small number from 0.00 to 9.99
  randomSmallNumber = random(1000) / 100.0;
  BlaeckSerial.markSignalUpdated("Small Number");
}

void UpdateRandomSmallNumber2()
{
  ...
  if ((millis() - updateLastTimeDone >= updateInterval) || updateFirstTime)
  {
    ...
    BlaeckSerial.markSignalUpdated("Small Number 2");
  }
}
